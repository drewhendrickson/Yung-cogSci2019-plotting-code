...
aic_2models_all_wide2 <- aic_2models_all_wide2[aic_2models_all_wide2$Word.object.pairs > 13,]
aic_2models_all_wide2$Word.object.pairs <- factor(aic_2models_all_wide2$Word.object.pairs)

ggplot(aic_2models_all_wide2,
       aes(x = kach_llh,
           y = pbv_llh,
           color = Word.object.pairs)) +
...
ggsave("vocab.pdf", width=10, height=6, units="in")
